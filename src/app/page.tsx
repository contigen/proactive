...
export default function Page() {
  return (
    <div className='mb-10'>
      <div className='bg-blue-500 px-20 py-10 text-white rounded-3xl mx-8 md:mx-20 my-14 flex items-center justify-evenly flex-wrap lg:flex-nowrap gap-10'>
        <h1>ProActive.</h1>
        <div>
          <svg
      ...
      <p className='text-2xl md:text-3xl font-[550] tracking-tight w-[50ch] my-8 mx-8 md:mx-20 max-w-full'>
